...
testClinicalControl(){
   result=`ajv compile --v5 -s OpenHealthContext/ClinicalControl/schema.json -r common-schema.json -r geometry-schema.json -r OpenHealthContext/body-height-1.0.json -r OpenHealthContext/body-weight-1.0.json -r OpenHealthContext/diastolic-blood-pressure-1.0.json -r OpenHealthContext/heart-rate-1.0.json -r OpenHealthContext/length-unit-value-1.0.json -r OpenHealthContext/systolic-blood-pressure-1.0.json -r OpenHealthContext/unit-value-1.x.json -r OpenHealthContext/mass-unit-value-1.x.json`
   assertEquals "schema OpenHealthContext/ClinicalControl/schema.json is valid" "${result}"
   result=`ajv test --v5 -s OpenHealthContext/ClinicalControl/schema.json -r common-schema.json -r geometry-schema.json -r OpenHealthContext/body-height-1.0.json -r OpenHealthContext/body-weight-1.0.json -r OpenHealthContext/diastolic-blood-pressure-1.0.json -r OpenHealthContext/heart-rate-1.0.json -r OpenHealthContext/length-unit-value-1.0.json -r OpenHealthContext/systolic-blood-pressure-1.0.json -r OpenHealthContext/unit-value-1.x.json -r OpenHealthContext/mass-unit-value-1.x.json -d OpenHealthContext/ClinicalControl/example.json --valid`
