...
Currently, for smart city scenario a set of alerts have been detected, such as: traffic jam, accident cars, and so on. However, for each type of alert, also a set of sub-types of alerts have been identified. For instances, subtypes of alerts of traffic jam: heavy traffic jam, car stopped on road, and so on. It is important to mention that an alert can see generated by a user or device. A catalogue of alerts subtypes have been defined a dn it is showed to below.
